...
class SettingNotFoundError(Exception):
    """Exception to be raised when a required setting is not available"""
    def __init__(self, setting):
        super().__init__(f"{setting} not found in settings.yaml file")
...
class RuntimeCredentialNotFoundError(Exception):
    ...
    def __init__(self):
        super().__init__("""Username/password not provided through CLI and runtime
                          emulatorAuthMethod selected. Configure another emulatorAuthMethod
                          or use the username/password flags to pass credentials to FABS""")
...
class EnvCredentialNotFoundError(Exception):
    ...
    def __init__(self):
        super().__init__("""FABS_EMULATOR_USERNAME and/or FABS_EMULATOR_PASSWORD environment
                          variables not found and env emulatorAuthMethod selected""")
